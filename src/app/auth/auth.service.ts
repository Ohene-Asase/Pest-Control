...
import { StoreKeys } from '../components/shared/config-keys';
import { User, LoginParams, Role, LoginResponse, RegisterParams } from '../auth/auth.model';
...
export class AuthService {
  ...
  register(credentials: RegisterParams): Observable<any>{
   return this.http.post(`${environment.baseApi}/auth/signup`, credentials)
